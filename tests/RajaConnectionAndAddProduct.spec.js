...
test("should log and add product ", async ({ page }) => {
  ...
  await expect(page).toHaveURL("https://stg-fr.rajapack.xyz/quick-order.html");
  ...
  await page.waitForTimeout(10000);
  await page.goto(
    "https://stg-fr.rajapack.xyz/INTERSHOP/web/WFS/RAJA-FR-Site/fr_FR/-/EUR/ViewCart-View"
  );

  await expect(page.locator("#basket-dropper").getByText("1")).toContainText(
    "1"
  );
});
